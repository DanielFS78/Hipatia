...
def decode_pila_json(dct: Dict[str, Any]) -> Any:
    """
...
def serialize_production_flow(production_flow: List[Dict[str, Any]]) -> Tuple[str, Dict[str, Any]]:
    """
...
def deserialize_production_flow(json_string: str) -> Tuple[List[Dict[str, Any]], Dict[str, Any]]:
    """
