...
class TestOrderListWidget:
    ...
    def mock_controller(self):
        ...
        controller.model = MagicMock(spec=['get_orders_for_product'])
        return controller
    ...
    def test_load_orders(self, widget, mock_controller, qtbot):
    ...
    def test_selection_signal(self, widget, mock_controller, qtbot):
    ...
    def test_clear_reset(self, widget, mock_controller):
        """Verifica el limpiado del widget."""
        mock_controller.model.get_orders_for_product.return_value = [OrdenFabricacionResumenDTO('OF-1', 'P', 'D', datetime.now())]
