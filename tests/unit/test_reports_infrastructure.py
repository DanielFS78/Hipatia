# -*- coding: utf-8 -*-
"""Tests de infraestructura de reportes: delegación AppModel → ReportsRepository."""
import pytest
...
class TestReportsInfrastructure:
    """
    Tests para verificar la infraestructura de datos del Módulo de Reportes (Fase 5.1).
    Verifica que AppModel delega correctamente en ReportsRepository.
    """
    ...
    def test_search_reports_data_delegation(self, app_model, mock_db_manager):
        ...
        query = "test"
        expected_result = [
            ResultadoBusquedaDTO("producto", "TEST-01", "Imán Test", datetime.now(), 10)
        ]
        mock_db_manager.reports_repo.buscar_por_codigo.return_value = expected_result
        
        # Act
        result = app_model.search_reports_data(query)
    ...
    def test_get_orders_for_product_delegation(self, app_model, mock_db_manager):
        """Verifica delegación de obtener_ordenes_por_producto."""
        # Arrange
        code = "PROD-123"
        expected = [
        ...
        # Act
        result = app_model.get_orders_for_product(code)
    ...
    def test_get_product_time_stats_delegation(self, app_model, mock_db_manager):
        """Verifica delegación de calcular_promedio_tiempo_unidad."""
        # Arrange
        code = "PROD-ABC"
        ...
        # Act
        result = app_model.get_product_time_stats(code)
    ...
    def test_get_evolution_stats_delegation_defaults(self, app_model, mock_db_manager):
        """Verifica delegación de obtener_evolucion_temporal con valor por defecto."""
        # Arrange
        code = "PROD-EVO"
        # Act
        app_model.get_evolution_stats(code)
    ...
    def test_get_incidents_stats_delegation(self, app_model, mock_db_manager):
        """Verifica delegación de obtener_incidencias_por_producto."""
        app_model.get_incidents_stats("P1")
    ...
    def test_get_worker_time_stats_delegation(self, app_model, mock_db_manager):
        """Verifica delegación de obtener_tiempos_por_trabajador."""
        app_model.get_worker_time_stats("P1")
    ...
    def test_get_order_details_delegation(self, app_model, mock_db_manager):
        """Verifica delegación de obtener_detalle_orden."""
        app_model.get_order_details("OF-999")
    ...
    def test_get_product_summary_delegation(self, app_model, mock_db_manager):
        """Verifica delegación de obtener_resumen_producto."""
        app_model.get_product_summary("P-SUM")
    ...
    def test_get_product_reports_dashboard_delegation(self, app_model, mock_db_manager):
        """Verifica delegación del bundle agregado de dashboard de reportes."""
        ...
        result = app_model.get_product_reports_dashboard("PROD-DASH", evolution_days=15)
