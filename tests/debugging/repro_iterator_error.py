...
class TestProductIteratorError(unittest.TestCase):
    def test_instantiation_error(self):
        ...
        # details = self.controller.model.get_product_details(self.product_code)
    ...
    def test_controller_has_methods(self):
        ...
        self.assertTrue(hasattr(ProductController, 'handle_add_iteration_image'), "Method handle_add_iteration_image missing")
        ...
        source_img = inspect.getsource(ProductController.handle_add_iteration_image)
    ...
    def test_app_model_delegation(self):
        ...
        self.assertIn("self.product_service.link_material_to_product", source)
        
        # Check add_material_to_iteration
        source_add = inspect.getsource(AppModel.add_material_to_iteration)
        self.assertIn("self.product_service.add_material_to_iteration", source_add)
